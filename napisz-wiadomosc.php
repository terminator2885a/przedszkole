        ...
        <main>
            ...
            <article>
                <h2>Nowa wiadomość</h2>
                 <nav>
                    <div class="nav__links">
                        <div class="nav__link"><a href="wiadomosci.php?"> Skrzynka odbiorcza</a></div>
                        <div class="nav__link"><a href="wiadomosci.php?wyslane"> Wysłane</a></div>
                        <div class="nav__link current"><a href="napisz-wiadomosc.php">Napisz wiadomość</a></div>
                    </div>
                </nav>
