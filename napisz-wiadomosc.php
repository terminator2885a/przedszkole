    ...
    <div class="page">
        ...
        <main>
            <aside>
                ...
                <div class="aside__link"><a href="wiadomosci.php?">Wiadomości <i class="fa-solid fa-arrow-right"></i> Skrzynka odbiorcza</a></div>
                <div class="aside__link"><a href="wiadomosci.php?wyslane">Wiadomości <i class="fa-solid fa-arrow-right"></i> Wysłane</a></div>
                <div class="aside__link current"><a href="napisz-wiadomosc.php">Wiadomości <i class="fa-solid fa-arrow-right"></i> Napisz wiadomość</a></div>
